...
<div class="heading">
   <h3>search page</h3>
   <p> <a href="<?php echo APP_BASE; ?>/pages/home.php">home</a> / search </p>
</div>
   ...
   <form action="" method="post" class="box">
      <div class="product-top">
         <div class="image-wrap">
            <img src="<?php echo APP_BASE; ?>/uploaded_img/<?php echo $fetch_product['image']; ?>" alt="" class="image">
